...
* Jenkins Master exposes NodePort 31091
* Jenkins Master with port 8080 exposed on an external LoadBalancer
...
| `Master.Image`             | Master image name                  | `reg.skycloud.com:5000/firmament/jenkins-master-k8s`       |
| `Master.ImageTag`          | Master image tag                   | `v0.6.0`                                                   |
...
| `Master.NodePort`          | k8s node port                      | `31091`                                                    |
...
| Parameter               | Description                        | Default                                                    |
| ----------------------- | ---------------------------------- | ---------------------------------------------------------- |
| `Agent.Image`           | Agent image name                   | `reg.skycloud.com:5000/firmament/jnlp-slave`               |
